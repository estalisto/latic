...
/**
 * VwConsultaClientesId generated by hbm2java
 */
public class VwConsultaClientesId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof VwConsultaClientesId) ) return false;
		 VwConsultaClientesId castOther = ( VwConsultaClientesId ) other; 
         
		 return ( (this.getCheckbox()==castOther.getCheckbox()) || ( this.getCheckbox()!=null && castOther.getCheckbox()!=null && this.getCheckbox().equals(castOther.getCheckbox()) ) )
 ...
 && ( (this.getEstado()==castOther.getEstado()) || ( this.getEstado()!=null && castOther.getEstado()!=null && this.getEstado().equals(castOther.getEstado()) ) );
   ...
   public int hashCode() {
         ...
         result = 37 * result + ( getCheckbox() == null ? 0 : this.getCheckbox().hashCode() );
