 ...
 * @author CIMA2015
 */
public class NotificacionesPagosServicios {
     public String getNotificacionesSaldosPendientes(int empresa, int agencia)
        {
            
            String valor = "", Query="select fnc_mis_notificaciones_saldos_pendientes("+empresa+","+agencia+");";
    ...
    //select fnc_add_campanias('okoko','2017-12-24 00:00:00','2017-12-18 00:00:00',1,1)
     ...
     public int AddNotificacionesPago(String descripcion, int empresa, int agencia, int id_documento)
        {
            
            String valor = "",updateQuery="select fnc_add_notificaciones_pagos('"+descripcion+"',"+empresa+","+agencia+","+id_documento+");";
            boolean ok=false;
            int campania=0;
         try{
