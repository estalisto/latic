...
public class ConsultaxCarteraServicios {
    UsuariosServicios loUserServ = new UsuariosServicios();
...
//        Query q = session.createQuery("from LcTipoGestion  E WHERE E.idCliente=:IDCliente and E.estado= :estado");
    ...
    public String getGestionCliente(int idCliente,int idDeudor){
         ...
         for(LcTransacciones datos:lista )
        {
            try {
             ...
             json.put("Usuario",loUserServ.getNombreUsuario(datos.getLcEmpleados().getIdEmpleado(),datos.getIdEmpresa()).toString().toUpperCase());// datos.getLcEmpleados().getNombres()+" "+datos.getLcEmpleados().getApellidos()); 
    ...
    public String getDetallesCuotasComprasJSON(int idCliente,int idDeudor){
        ...
        SimpleDateFormat dateFormatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        String html="";
        Boolean loRegistraSum=false;
        BigDecimal Suman = BigDecimal.ZERO, Valor= BigDecimal.ZERO;
       ...
       Query q = session.createQuery("from LcCuotas  E WHERE  E.lcDatosDeudores.idDatosDeudor = :idDeudor  and   E.idCliente= :idCliente and  E.estado= :estado order by E.fechaMaxPago DESC");       
         ...
         for(LcCuotas mrol:lista )
        {
            ...
            // System.out.println("ok: "+mrol.getLcClientes().getRazonSocial()+" "+ mrol.getLcDatosDeudores().getNombres()+" "+mrol.getLcTipoGestion().getNombreTipoGestion()+" "+ mrol.getLcTipoResultado().getNombreTipoResultado()+""+mrol.getLcEmpleados().getNombres()+""+mrol.getLcEmpleados().getApellidos());
             ...
             json.put("Fecha", FechaCompra);
             itemSelectedJson.add(json);*/
             if(loArticulo.equals(mrol.getLcArticulo().getReferencia()))
             {
                Suman=BigDecimal.ZERO;
                if(loRegistraSum)
                {
                    html=html+"<tr><td><Strong>Total:</Strong></td>";
                    html=html+"<td></td>";
                    html=html+"<td></td>";
                    html=html+"<td></td>";
                    html=html+"<td></td>";
                    ...
                    html=html+"<td></td>";
                    html=html+"<td></td>";
                    html=html+"<td><Strong>"+Suman+"</Strong></td>";
                    html=html+"<td></td>";
                    html=html+"<td></td>";
                    html=html+"<td></td>";
                    html=html+"<td></td></tr>";
            ...
            html=html+"<td>"+mrol.getLcArticulo().getReferencia()+"</td>";
            html=html+"<td>"+mrol.getLcArticulo().getNombreArticulo()+"</td>";
            html=html+"<td>"+mrol.getNumCuotas()+"</td>";
            html=html+"<td>"+mrol.getInteresCuota()+"</td>";
            html=html+"<td>"+mrol.getValorMora()+"</td>";
            html=html+"<td>"+mrol.getGastosCobranzas()+"</td>";
            html=html+"<td>"+mrol.getGastosAdicional()+"</td>";
            html=html+"<td>"+mrol.getOtrosValores()+"</td>";
            html=html+"<td>"+mrol.getValorCuota()+"</td>";
            html=html+"<td>"+mrol.getValorMora().add(mrol.getInteresCuota()).add(mrol.getValorMora()).add(mrol.getGastosCobranzas()).add(mrol.getGastosAdicional()).add(mrol.getOtrosValores()).add(mrol.getValorCuota())+"</td>";
            html=html+"<td>"+FechaMaxPago+"</td>";
            html=html+"<td>0</td>";
            html=html+"<td></td>";
            html=html+"<td>"+FechaCompra+"</td>";
            
            Valor=mrol.getValorMora().add(mrol.getInteresCuota()).add(mrol.getValorMora()).add(mrol.getGastosCobranzas()).add(mrol.getGastosAdicional()).add(mrol.getOtrosValores()).add(mrol.getValorCuota());
            Suman= Suman.add(Valor);
