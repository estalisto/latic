...
table tr {
    bgcolor: #E0ECF8;
        ...
        <body>
            <div id="div_crear_campania">
                ...
                <div class="panel panel-warning well-sm">
                    <center><h3>CREAR CAMPAÑAS</h3></center>
                    <hr>
                    <div>

                       <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalAgregar">+ Nueva Campaña</button>
                    </div>
                ...
                <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <h4 class="modal-title">Formulario para Crear la Campaña</h4>
                    </div>
                    <div class="modal-body">
                       <form class="form-horizontal">
                        ...
                        <div class="form-group">
                          <label class="control-label col-sm-3" for="pwd">Fecha Inicio:</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="finicio" placeholder="YYYY-MM-DD hh24:mi:ss">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label col-sm-3" for="pwd">Fecha Fin:</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="ffin" placeholder="YYYY-MM-DD hh24:mi:ss">
                          </div>
                        </div>
                        
                        <div class="form-group">
                          <div class="col-sm-offset-2 col-sm-10">
                              <button type="button" class="btn btn-primary" onclick="agregar_campania();">Crear Campaña</button>
                          </div>
                        </div>
                      </form> 
                    </div>
        ...
        <script charset="UTF-8" src="dist/js/campanias.js"></script>
        <script>
          consulta_campanias();
