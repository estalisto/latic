...
--%>
<%@page import="com.laticobsa.servicios.ParametrosServicios"%>
             ...
             <div class="col-sm-8">
                 ...
                 <form class="form-inline form-control-sm">
                     ...
                     <div class="input-group input-group-sm">
                        <span class="input-group-addon " >Total Vencido: $</span>
                        <input type="text" class="form-control text-right"id="ttvencidos" placeholder="0.00" aria-describedby="sizing-addon3">
                      </div>
                    <div class="input-group input-group-sm">
                        <span class="input-group-addon " >Pagos: $</span>
                        <input type="text" class="form-control text-right" id="ttpagos" placeholder="0.00" aria-describedby="sizing-addon3">
                      </div>
                    <div class="input-group input-group-sm">
                        <span class="input-group-addon " >Saldos: $</span>
                        <input type="text" class="form-control text-right" id="ttsaldos" placeholder="0.00" aria-describedby="sizing-addon3">
                      </div>
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div class="col-lg-6">
                                                                    <div class="form-inline">
                                                                                    ...
                                                                                    <input size="5" type="text" class="form-control input-sm" id="dia_mora" name="idmora" placeholder="0" >
                                                                                    <input size="5" type="text" class="form-control input-sm" id="dia_mora1" name="idmora1" placeholder="0" >
                                                                    </div>
                                                                    <div class="form-inline">
...
<div id="gestion_cliente" hidden>
                <div class="panel panel-default well margin">
                        <div class="row">
                            ...
                            <div class="col-lg-2"> 
                                <button id="anterior" type="button" onclick="Antdeudor2()" class="btn btn-primary glyphicon glyphicon-arrow-left"></button>
                                <button id="siguiente" type="button" onclick="Sgtedeudor2()" class="btn btn-primary  glyphicon glyphicon-arrow-right"> </button>
                                <br>
                                <label class="col-sm-1 control-label " id="usuaioasignado"></label> 
                            </div>  
                            <div class="col-lg-1">
                        ...
                        <!--div class="btn-toolbar" role="toolbar"-->                    
                                    ...
                                    <div id="referencia" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="actulizacion">
                                     ...
                                     <div id="det_articulo"  class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="detalle_articulo">
                                      ...
                                      <!--  sadsasds-->
                                       <!-- Modal -->
                                        <div class="modal fade" id="det_cuotas" role="dialog">
                                    ...
                                    <div id="" class="modal fade " tabindex="-1" role="dialog" aria-labelledby="detalle_cuota">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                <br><div class="box box-danger">
                                                    <div class="box-header with-border bg-yellow">
...
consultaMisClientes();
var lv_query_sum="select sum(s.total_vencidos) as total_vencidos, sum(pagos) as pagos, (sum(s.total_vencidos) -  sum(pagos)) as saldo  from  vw_consulta_cartera s  where s.id_empleado=IDEmpleadoConsulta and s.estado != 'E'";
