...
function obtenerResultado() {
    ...
    console.log(">>>>>  idcartera: "+idcliente);
  ...
  $.getJSON("cobranzas", {"accion" : accion,"idCliente":idCliente,"idDeudor":idDeudor}, function(result){
         console.log(result);
          $.each(result.ClienteDeudor, function(key, val){             
             ...
             document.getElementById("usuaioasignado").innerHTML="Usuario: "+val.Usuario; 
...
function GestionesJson(idCliente, idDeudor){
    ...
    console.log(">>>>>>>>>>>idCliente"+idCliente+"idDeudor"+ idDeudor);
        $(document).ready(function() {	
   ...
   // ComprasJson(idCliente, idDeudor);
    ...
    var parametros = {"accion": "DetalleCuotas","idCliente": idCliente,"idDeudor": idDeudor};
        $.ajax({
            ...
            success: function (response) {  
                document.getElementById("TablaDetalleCuotas").innerHTML  =TablaCompras+"<body>"+response.toString()+"</body>"+toEndTable;              
            }
        });
