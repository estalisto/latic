          ...
          <div class="box box-danger">
            ...
            <form name="form" action="clientes" method="get" class="well">
                ...
                <div class="form-group">
                            ...
                            <option value="<c:out value="${cliento.getLcEmpresa().getRazonSocial()}" />"><c:out value="${cliento.getLcEmpresa().getRazonSocial()}" /></option>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <select class="form-control" name="Tipo_Identificacion" required="required" id="Tipo_Identificacion">
                                <option value="<c:out value="${cliento.getTipoIdentificacion()}" />"><c:out value="${cliento.getTipoIdentificacion()}" /></option>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <select class="form-control" name="pais" required="required" id="pais" >
                                <option value="<c:out value="${cliento.getPais()}" />"><c:out value="${cliento.getPais()}" /></option>
                        ...
                        <div class="col-lg-4">
                            ...
                            <select class="form-control" name="Provincia" required="required" id="Provincia" >
                                <option value="<c:out value="${cliento.getProvincia()}" />"><c:out value="${cliento.getProvincia()}" /></option>
                        ...
                        <div class="col-lg-4">
                            ...
                            <select class="form-control" name="Ciudad" required="required" id="Ciudad" >
                                <option value="<c:out value="${cliento.getCiudad()}" />"><c:out value="${cliento.getCiudad()}" /></option>
